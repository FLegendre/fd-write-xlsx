#ifndef FD_WRITE_XLSX_HEADER_ONLY_HPP
#define FD_WRITE_XLSX_HEADER_ONLY_HPP
  ...
  <Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="worksheets/sheet1.xml"/>
	...
	// </worksheet>
	{
		...
		for (auto const& row : sheet) {
			auto const str_i{ std::to_string(&row - &sheet[0] + 1) };
...
{
	write(xlsx_file_name.c_str(), sheet);
}
} // namespace fd_write_xlsx
#endif // FD_WRITE_XLSX_HEADER_ONLY_HPP
